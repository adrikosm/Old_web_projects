        ...
        <div class="row">
            <div class="col-md-5">
				...
				<?php if (startpoint_get_option('startpoint_footertext') != '') { ?>
					...
					<?php } else { ?>
                    <p><a rel="nofollow" href="<?php echo esc_url('http://www.inkthemes.com'); ?>"><?php _e('StartPoint Theme', 'start-point'); ?></a> <?php _e('Powered By ', 'start-point'); ?><a href="<?php echo esc_url('http://www.wordpress.org'); ?>"><?php _e(' WordPress', 'start-point'); ?></a></p>
					<?php } ?>
                </div>
            </div>
